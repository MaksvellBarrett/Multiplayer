...
public class CustomHandAndHeadManager : OVRCameraRig
{
	...
	private void UpdateEyeAnchorsIfNeedIt(bool updateEyeAnchors, bool hmdPresent, Quaternion emulatedRotation,bool monoscopic) 
	{
		if (updateEyeAnchors && HandView.IsMine)
		{
			UpdateCenterEyeAnchorIfNeedIt(hmdPresent, emulatedRotation);
			UpdateLeftAndRightEyeAnchorIfNeedIt(hmdPresent, monoscopic);
		}
	}

	private void UpdateCenterEyeAnchorIfNeedIt(bool hmdPresent, Quaternion emulatedRotation) 
	{
		if (hmdPresent)
		{
	...
	private void UpdateLeftAndRightEyeAnchorIfNeedIt(bool hmdPresent,bool monoscopic) 
	{
